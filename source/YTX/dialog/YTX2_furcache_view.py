...
class Ui_YTX2_fur_mw(QtWidgets.QMainWindow):
    close_signal = QtCore.pyqtSignal(list)
    ...
    def setupUi(self):
        ...
        self.YTX2_select_view_hl = QtWidgets.QHBoxLayout()
        self.YTX2_select_view_hl.setObjectName("YTX2_select_view_hl")
        self.YTX2_task_tw = QtWidgets.QTabWidget(self.centralwidget)
        self.YTX2_task_tw.setObjectName("YTX2_task_tw")
        self.YTX2_task_hl = QtWidgets.QWidget()
        self.YTX2_task_hl.setObjectName("YTX2_task_hl")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.YTX2_task_hl)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.YTX2_task_view_lw = QtWidgets.QListWidget(self.YTX2_task_hl)
        ...
        self.YTX2_folder_tw = QtWidgets.QTabWidget(self.centralwidget)
        self.YTX2_folder_tw.setObjectName("YTX2_folder_tw")
        self.YTX2_folder_hl = QtWidgets.QWidget()
        self.YTX2_folder_hl.setObjectName("YTX2_folder_hl")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.YTX2_folder_hl)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.YTX2_folder_view_lw = QtWidgets.QListWidget(self.YTX2_folder_hl)
        ...
        self.YTX2_version_tw = QtWidgets.QTabWidget(self.centralwidget)
        self.YTX2_version_tw.setObjectName("YTX2_version_tw")
        self.YTX2_version_hl = QtWidgets.QWidget()
        self.YTX2_version_hl.setObjectName("YTX2_version_hl")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.YTX2_version_hl)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.YTX2_version_view_lw = QtWidgets.QListWidget(self.YTX2_version_hl)
    ...
    def set_folder_data(self, item :QtWidgets.QListWidgetItem) -> None:
        ...
        for fur_dir in fur_dir_list:
            folder_item = QtWidgets.QListWidgetItem(path.basename(fur_dir))
            folder_item.setWhatsThis(path.join(fur_dir, "fur"))
            self.YTX2_folder_view_lw.addItem(folder_item)


    def set_version_data(self, item :QtWidgets.QListWidgetItem) -> None:
    ...
    def set_assign_path(self) -> None:
        def get_selected_item(list_widget :QtWidgets.QListWidget) -> str:
