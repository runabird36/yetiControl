...
class AnimSelector(Selector):
    ...
    def __init__(self):
        ...
        #     self.anim_selection_dict = {'Export type':['playblast', 'alembic cache', 'maya'], \
        ...
        if LUCY.get_pipe_step() == 'matchmove':
            self.anim_selection_dict = {'Export type':[ 'alembic cache', 'maya'], \
                                    'Export Options':['World space', 'Write Visibility', 'Filter Euler Rotations', 'Strip Namespaces', 'UV write']
                                    }
        else:
            self.anim_selection_dict = {'Export type':[ 'alembic cache', 'USD', 'maya'], \
                                    'Export Options':['World space', 'Write Visibility', 'Filter Euler Rotations', 'Strip Namespaces', 'UV write']
                                    }
