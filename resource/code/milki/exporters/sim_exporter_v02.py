...
class SimExporter(Exporter):
    ...
    def pre_execute(self, targets, options):
        ...
        pprint(self.options)
        '''111111111111
        ['abrelshud_test_YETI_003Shape',
        'abrelshud_test_YETI_002Shape',
        'abrelshud_test_YETI_001Shape']
        {'End Frame': ['1020.0'], 'Samples': ['3.0'], 'Start Frame': ['1001.0']}'''



        cmds.ls(created_yeti, dag=True, noIntermediate=True, typ='pgYetiMaya')
